...
export function Categori() {
    ...
    console.log(modalData.group && groups.find(item => item.id === modalData.group)?.persianName);
                                ...
                                <div className="selected-home">
                                    ...
                                    <div className="div-input-select">
                                        <select class="form-select"
                                            ...
                                            defaultValue={modalData.group && groups.find(item => item.id === modalData.group)?.persianName}
                                            >
                                            <option selected>انتخاب کنید</option>
                                            {editGroups
                                ...
                                <div className="selected-home">
                                    ...
                                    <div className="div-input-select-home">
                                        <select class="form-select"
                                            ...
                                            defaultValue={selectedSuubGroupId !== null ? selectedSuubGroupId : ''}
